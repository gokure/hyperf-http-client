...
use Gokure\Http\Client\Events\ConnectionFailed;
...
class PendingRequest
{
     ...
     *
     * @var \Gokure\Http\Client\Factory|null
     */
    protected $factory;
     ...
     *
     * @var \Hyperf\Utils\Collection|null
     */
     ...
     *
     * @var \Gokure\Http\Client\Request|null
     */
    protected $request;
     ...
     * @return \Gokure\Http\Client\Response
     */
    ...
    {
        $handler = Coroutine::getCid() > 0 ? new CoroutineHandler() : null;
